function I = intersectRaySurface(FV,pts,D)
...
%
% ----------------- INPUT ----------------- 
% FV must contain fields 'faces' and 'vertices'
% pts = n x 3 matrix with xyz coordinates of n points
