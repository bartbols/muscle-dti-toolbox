% This script is an example of fibre tracking using DSI studio.
% Clear the workspace
clear
...
% extension .mat.
filename.Tracts  = fullfile(results_path,'tracts','CALF001_DTI_MG_dsi.mat');
...
filename.ROA        = fullfile(results_path,'DTI_masks','CALF001_DTI_LPCA_FA.nii.gz');
...
[DTItracts,StopFlag] = TrackFibres(filename,TrackSettings);
