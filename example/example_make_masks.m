...
filename.DTI   = fullfile(datapath,'CALF001_DTI.nii.gz');  % name of DTI data for subject 1
filename.FIB   = fullfile(results_path,'CALF001_DTI_LPCA.fib.gz'); % name of .fib file for subject 1
filename.mask  = fullfile(datapath,'masks','CALF001_T1_anat_labels.nii.gz'); % name of the segmentation file (generated by ITK-snap, for example)
...
% function.
mask_filenames = MakeSurfaceAndMasks( filename.mask,filename.DTI,...
...
% LabelNames = {'MG'};
% mask_filenames = MakeSurfaceAndMasks( segm_filename,filename.DTI,...
